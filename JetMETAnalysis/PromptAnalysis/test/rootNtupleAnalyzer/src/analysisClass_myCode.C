...
void analysisClass::Loop()
{
   ...
   TH1F *h_MET    = new TH1F ("h_MET","h_MET",100,0,200);
   TH1F *h_myMET    = new TH1F ("h_myMET","h_myMET",100,0,200);

   TH1F *h_HadMET    = new TH1F ("h_HadMET","h_HadMET",100,0,200);
   TH1F *h_HadMETx    = new TH1F ("h_HadMETx","h_HadMETx",100,-200,200);
   TH1F *h_HadMETy    = new TH1F ("h_HadMETy","h_HadMETy",100,-200,200);

   TH1F *h_HadSumEt    = new TH1F ("h_HadSumEt","h_HadSumEt",100,0,2000);
...
// 	 if(ls<24 || ls >37) continue;
       ...
       for (int ii=0; ii<vertexZ->size(); ii++)
	 {
       ...
       h_MET->Fill(calometPt->at(0));
       h_myMET->Fill(my_Met);

       h_HadMET->Fill(my_MetHAD);
       h_HadMETx->Fill(my_MetHAD_x);
       h_HadMETy->Fill(my_MetHAD_y);
       h_HadSumEt->Fill(my_SumetHAD);
