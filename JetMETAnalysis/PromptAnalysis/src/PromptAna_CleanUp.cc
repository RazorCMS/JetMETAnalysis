...
PromptAna_CleanUp::PromptAna_CleanUp(const edm::ParameterSet& iConfig) 
{
  ...
  produces <int>   ( prefix + "NumIsolatedNoiseChannels" + suffix);
  produces <float>   ( prefix + "IsolatedNoiseSumEt" + suffix);
}
...
void PromptAna_CleanUp::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) 
{
  ...
  std::auto_ptr<int>   f_numIsolatedNoiseChannels ( new int() );
  std::auto_ptr<float>   f_isolatedNoiseSumEt ( new float() );
  ...
  *f_numIsolatedNoiseChannels.get()=HNoiseSummary->numIsolatedNoiseChannels();
  *f_isolatedNoiseSumEt.get()=HNoiseSummary->isolatedNoiseSumEt();
  ...
  iEvent.put( f_numIsolatedNoiseChannels    ,   prefix + "NumIsolatedNoiseChannels" + suffix );
  iEvent.put( f_isolatedNoiseSumEt          ,   prefix + "IsolatedNoiseSumEt" + suffix );
}
